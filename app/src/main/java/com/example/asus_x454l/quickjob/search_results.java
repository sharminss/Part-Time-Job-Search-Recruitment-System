...
public class search_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewjobnew = (ListView) findViewById(R.id.listnewr);
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(search_results.this, "please wait....", "processing...", true);
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if(img.getName2().toLowerCase().contains(val.toLowerCase())) {
                        jobListnew.add(img);
                    }
                }


                Joblist adapter = new Joblist(search_results.this, jobListnew);
