...
public class Strorage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strorage);
    ...
    public void btnUpload_Click(View v) {
        ...
        if (imguri != null) {
            ...
            ref.putFile(imguri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(getApplicationContext(), "Info uploaded", Toast.LENGTH_SHORT).show();
        ...
        {
            Toast.makeText(getApplicationContext(), "contact number is not valid..please recheck", Toast.LENGTH_SHORT).show();
